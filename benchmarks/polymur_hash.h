...
{
    return ((v >> 24) & 0x000000ffUL) | ((v >> 8) & 0x0000ff00UL) | ((v << 8) & 0x00ff0000UL) |
           ((v << 24) & 0xff000000UL);
}
...
static inline polymur_u128_t polymur_add128(polymur_u128_t a, polymur_u128_t b) { return a + b; }
...
static inline uint64_t polymur_extrared611(uint64_t x) { return (x & POLYMUR_P611) + (x >> 61); }
