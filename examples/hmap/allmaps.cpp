...
int main(int, char**)
{
    ...
    test_set<gtl::node_hash_set<int>>(make_int);
    test_set<gtl::node_hash_set<string>>(make_string);

    test_set<gtl::flat_hash_map<int, int>>(make_2int);
    test_set<gtl::flat_hash_map<string, string>>(make_2string);

    test_set<gtl::node_hash_map<int, int>>(make_2int);
    test_set<gtl::node_hash_map<string, string>>(make_2string);

    test_set<gtl::parallel_flat_hash_set<int>>(make_int);
    test_set<gtl::parallel_flat_hash_set<string>>(make_string);

    test_set<gtl::parallel_node_hash_set<int>>(make_int);
    test_set<gtl::parallel_node_hash_set<string>>(make_string);

    test_set<gtl::parallel_flat_hash_map<int, int>>(make_2int);
    test_set<gtl::parallel_flat_hash_map<string, string>>(make_2string);

    test_set<gtl::parallel_node_hash_map<int, int>>(make_2int);
