...
#ifndef GTL_PRIV_UNORDERED_MAP_MEMBERS_TEST_H_
#define GTL_PRIV_UNORDERED_MAP_MEMBERS_TEST_H_
...
TYPED_TEST_P(MembersTest, Typedefs)
{
    ...
    EXPECT_TRUE((std::is_convertible<decltype(std::declval<const typename TypeParam::hasher&>()(
...
#endif // GTL_PRIV_UNORDERED_MAP_MEMBERS_TEST_H_
