...
#ifndef GTL_PRIV_HASH_POLICY_TESTING_H_
#define GTL_PRIV_HASH_POLICY_TESTING_H_
...
struct StatefulTestingHash
    : gtl::priv::hash_testing_internal::WithId<
          StatefulTestingHash> 
{
    template <class T>
...
// GTL_UNORDERED_SUPPORTS_ALLOC_CTORS is false for glibcxx versions
...
#endif  // GTL_PRIV_HASH_POLICY_TESTING_H_
