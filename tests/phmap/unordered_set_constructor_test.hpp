...
#ifndef GTL_PRIV_UNORDERED_SET_CONSTRUCTOR_TEST_H_
#define GTL_PRIV_UNORDERED_SET_CONSTRUCTOR_TEST_H_

#include <algorithm>
#include <unordered_set>
#include <vector>

#include "hash_generator_testing.hpp"
...
template<typename T>
using expect_cxx14_apis = std::disjunction<std::negation<is_std_unordered_set<T>>, has_cxx14_std_apis>;
...
#if GTL_UNORDERED_SUPPORTS_ALLOC_CTORS
...
template<typename T>
using expect_alloc_constructors = std::disjunction<std::negation<is_std_unordered_set<T>>, has_alloc_std_constructors>;
...
REGISTER_TYPED_TEST_SUITE_P(ConstructorTest,
                            NoArgs,
                            BucketCount,
                            BucketCountHash,
...
#endif // GTL_PRIV_UNORDERED_SET_CONSTRUCTOR_TEST_H_
