...
#ifndef GTL_CONTAINER_INTERNAL_TEST_INSTANCE_TRACKER_H_
#define GTL_CONTAINER_INTERNAL_TEST_INSTANCE_TRACKER_H_
...
public:
    ...
    // constructed
    int instances() const { return BaseCountedInstance::num_instances_ - start_instances_; }

    // Returns the number of live BaseCountedInstance instances compared to when
    // the InstanceTracker was constructed
    int live_instances() const { return BaseCountedInstance::num_live_instances_ - start_live_instances_; }
    ...
    int copies() const { return BaseCountedInstance::num_copies_ - start_copies_; }
    ...
    // construction or the last call to ResetCopiesMovesSwaps().
    int comparisons() const { return BaseCountedInstance::num_comparisons_ - start_comparisons_; }
...
#endif // GTL_CONTAINER_INTERNAL_TEST_INSTANCE_TRACKER_H_
