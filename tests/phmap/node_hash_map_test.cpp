...
using MapTypes = ::testing::Types<
    gtl::THIS_HASH_MAP<int, int, StatefulTestingHash, StatefulTestingEqual,
                        Alloc<std::pair<const int, int>>>,
    gtl::THIS_HASH_MAP<std::string, std::string, StatefulTestingHash,
...
TEST(THIS_TEST_NAME, MergeExtractInsert) {
  gtl::THIS_HASH_MAP<NonMovableKey, int, NonMovableKeyHash, NonMovableKeyEq>
      set1, set2;
