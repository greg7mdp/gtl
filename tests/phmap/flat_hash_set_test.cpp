...
#include "unordered_set_constructor_test.hpp"
#include "unordered_set_lookup_test.hpp"
#include "unordered_set_members_test.hpp"
#include "unordered_set_modifiers_test.hpp"
...
template<class T>
using Set = gtl::THIS_HASH_SET<T, StatefulTestingHash, StatefulTestingEqual, Alloc<T>>;
